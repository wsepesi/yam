  ...
  return (
    <Layout title="Page Not Found" glassy={false}>
      <div className="flex flex-col items-center justify-center text-center px-4 h-[80vh]">
        ...
        <h2 className="text-2xl font-semibold text-[rgb(71,24,3)] mb-6">
          Oops! Page Not Found.
        </h2>
        ...
        <Link
          href="/"
          className="px-6 py-3 bg-[#471803] text-white font-semibold rounded-md hover:bg-opacity-80 transition-colors"
        >
          Go to Homepage
        </Link>
      </div>
